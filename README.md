Вот готовое описание — можешь вставлять на Playground (структурировано по вкладкам, легко читается).
...
Хочешь — сделаю короткую версию (для превью/анонса), английскую версию, или добавлю раздел «Установка» пошагово / скриншоты-подписи. Скажи, что подправить (тон, акценты, убрать/добавить фичи).
